...
public class SchoolDirectory {
    public static void main(String[] args) {
        ...
        Principal primarySchoolPrincipal=new Principal("Emil Kowalski");
        Principal highSchoolPrincipal=new Principal("Sarah Nowinski");
        Principal vocationalSchoolPrincipal=new Principal("Chris Newton");
